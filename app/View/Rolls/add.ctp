<div class="rolls form">
	...
	<div class="row">
					...
					<div class="panel-heading"><?php echo __('Actions'); ?></div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;'.__('List Rolls'), array('action' => 'index'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Roll', array('role' => 'form')); ?>

				<div class="form-group">
					<?php echo $this->Form->input('rollname', array('class' => 'form-control', 'placeholder' => 'Rollname'));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('Project', array('class' => 'form-control', 'placeholder' => 'Rollname'));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('User', array('class' => 'form-control', 'placeholder' => 'Rollname'));?>
				</div>
				<div class="form-group">
